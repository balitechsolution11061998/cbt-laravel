...
<html lang="en">
  <head>
    ...
    <!-- Flaticon Font -->
    <link href="{{ asset('assetsfrontend/lib/flaticon/font/flaticon.css')}}" rel="stylesheet" />

    <!-- Libraries Stylesheet -->
    <link href="{{ asset('assetsfrontend/lib/owlcarousel/assets/owl.carousel.min.css')}}" rel="stylesheet" />
    <link href="{{ asset('assetsfrontend/lib/lightbox/css/lightbox.min.css')}}" rel="stylesheet" />
  ...
  <body>
    ...
    <div class="container-fluid bg-primary px-0 px-md-5 mb-5">
      <div class="row align-items-center px-3">
        ...
        <div class="col-lg-6 text-center text-lg-right">
          <img class="img-fluid mt-5" src="{{ asset('assetsfrontend/img/header.png')}}" alt="" />
        </div>
      </div>
    </div>
    <!-- Header End -->
    ...
    <script src="{{ asset('assetsfrontend/lib/isotope/isotope.pkgd.min.js')}}"></script>
    <script src="{{ asset('assetsfrontend/lib/lightbox/js/lightbox.min.js')}}"></script>

    <!-- Contact Javascript File -->
    <script src="{{ asset('assetsfrontend/mail/jqBootstrapValidation.min.js')}}"></script>
    <script src="{{ asset('assetsfrontend/mail/contact.js')}}"></script>
