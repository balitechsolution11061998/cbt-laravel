        ...
        <div class="col-xl-8 mb-5 mb-xl-10">
            ...
            <div class="row g-lg-5 g-xl-10">
                    ...
                    <div class="card overflow-hidden h-md-50 mb-5 mb-xl-10" id="cardCountPo">
                        ...
                        <div class="card-body d-flex justify-content-between flex-column px-0 pb-0">
                            ...
                            <div class="mb-4 px-9">
                                ...
                                <!--end::Info-->
                                <!--begin::Description-->
                                <span class="fs-6 fw-semibold text-gray-500">Total Purchase Order</span>
                                <!--end::Description-->
                            </div>
                            <!--end::Statistics-->
                            <!--begin::Chart-->
                            <div id="chart-po" class="min-h-auto" style="height: 350px"></div>
                            <!--end::Chart-->
                        </div>
                        <!--end::Card body-->
                    </div>
                ...
                <div class="col-md-6 col-xl-6 mb-md-5 mb-xl-10">
                    ...
                    <div class="card overflow-hidden h-md-50 mb-5 mb-xl-10" id="cardCountRcv">
                        <div class="card-body d-flex justify-content-between flex-column px-0 pb-0">
                            ...
                            <div id="chart-rcv" class="min-h-auto" style="height: 350px"></div>
                        </div>
                    </div>
